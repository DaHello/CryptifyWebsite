...
First, to start the json server in order to access the json file as a mock database:


Then start the web site, which will fetch the file hosted on the json server:
### `npm start`
